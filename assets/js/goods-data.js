...
const GOODS = {
  ...
  products: [
    ...
    {
      id: "yukata-bromide",
      name: "浴衣衣装ランダムブロマイド（3枚入り）",
      deco: "浴衣衣装ランダムブロマイド(3枚入り)全41種",
      category: "ブロマイド", series: "yukata",
      img: "yukata-main.webp", price: 1000,
      variantType: "fixed",
      variants: [{ key: "default", sid: 48354407448812, label: "全41種ランダム", price: 1000, img: "yukata-main.webp" }],
    ...
    },
    {
      ...
      notes: ["ランダム封入のため絵柄はお選びいただけません", "数量限定商品のため、なくなり次第、販売終了となります。"],
      random: { label: "各全6種" },
    },
    {
      id: "hinafu-tcard",
    ...
    },
    {
      ...
      variants: [
        ...
        { key: "all",    sid: 47393174913260, label: "All Member",  price: 1000, img: "charm-all.webp" },
      ],
