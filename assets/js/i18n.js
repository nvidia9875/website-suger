...
const SN_I18N = {
  ja: {
    ...
    goods: {
      ...
      allMember: "全員集合",
      gallery: "絵柄サンプル", galleryNote: "掲載しているのは絵柄の一部です。画像の透かしは実際の商品には入りません。",
  ...
  en: {
    ...
    goods: {
      ...
      gallery: "Design samples", galleryNote: "A few of the designs. The watermark does not appear on the actual product.",
  ...
  th: {
    ...
    goods: {
      ...
      gallery: "ตัวอย่างลาย", galleryNote: "เป็นตัวอย่างลายบางส่วน ลายน้ำจะไม่ปรากฏบนสินค้าจริง",
      priceRange: "{label}: {price}",
